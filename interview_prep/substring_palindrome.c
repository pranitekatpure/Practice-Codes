...
*/
/* Method 2: Select possible centers and the move out from it while checking for palindrome.
For Odd size substring center will be single character while for even size substring center will be 2 characters. TC: O(n2) */
...
int count_of_substrs(char *str) 
{
        ...
        for (int i = 0; i < strlen(str); i++) 
		{
            ...
            res += count_palindromes(str, i, i);

            /* Length of Palindrome is Even. */
            res += count_palindromes(str, i, i + 1);
        }
